        ...
        <>
            <section className={`${(showSignInScene || showRegisterScene) ? "blur-sm pointer-events-none" : ""}`}>
                ...
                <section className="mission-section">
                    <section className="max-width max-w-screen-xl m-auto flex flex-col px-4 pt-8">
                        <section className="heading">
                            <HeadingComponent1 title={"mission"} lineWidth={"w-[120%]"} customCSS={"!mb-4"} showRightSide={false} />
                        </section>
                        <section className="mission-description font-bold md:text-xl sm:text-base text-xs flex justify-between md:gap-16 sm:gap-10 gap-4">
                            To transform relationships into lasting partnerships, delivering unparalleled value and rewards to our clients` customers fostering trust and loyalty.
                            <ArrowOnTarget1 width={100} height={100} customCSS={"md:min-w-[100px] md:h-auto w-14 h-14"} />
                        </section>
                    </section>
                </section>
