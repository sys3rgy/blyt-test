...
const BuyerSignInPage: React.FC = () => {
    ...
    async function signIn() {
        ...
        const response = await axios.post('/api/buyersAPIs/buyerSignInAPI', data)
    ...
    async function verifyUserWhoseAccAreVerified() {
        ...
        const response = await axios.put('/api/buyersAPIs/buyerSignInAPI', data);
        const statusCode = response.data.statusCode;
        const message = response.data.message;
